...
- [ ] BUG-024 Take the zero prompt's heredoc out of the command substitution so `claudezero.sh` parses under bash 3.2 — stock macOS `/bin/bash` dies at parse time today and the macOS CI leg is red
